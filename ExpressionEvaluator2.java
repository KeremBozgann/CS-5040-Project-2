...
//    } 
    ...
    public static Double evaluate(String expr) { 
        ...
        if (ExpressionEvaluator.checkForMultipleOperatorsAndPrefix(substrings))
        {}
        //check if - and / get at least one operand:
        if (ExpressionEvaluator.checkForCorrectIdentity(substrings))
        {}
     ...
     */
    private static Integer readInput2(String elem) throws IOException  { 
